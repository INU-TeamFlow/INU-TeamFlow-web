...
export default function LoginScreen() {
  ...
  return (
    ...
    >
      ...
      <View className="rounded-3xl bg-white px-6 pb-8 pt-10 border-[0.5px] border-[#D6DDE5]">
        <Text className="mb-6 text-center text-[26px] font-bold text-[#2c2c2c]">
          {LOGIN_TEXT.TITLE}
        </Text>

        <View className="mb-1">
          <Text className="mx-7.5 mb-1 text-[14px] font-medium text-[#989898]">
          ...
          <View className="mx-7.5 mb-4">
            <TextInput
              ...
              autoCapitalize="none"
              className="h-[53px] w-full rounded-full bg-[#F6F8FA] px-5 text-[15px] text-[#2C2C2C]"
            />
          </View>
        </View>
