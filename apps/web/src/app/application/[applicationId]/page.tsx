      ...
      <section className="mx-auto mt-8 flex min-h-[calc(100vh-48px)] max-w-[800px] flex-col sm:mt-12 sm:min-h-[calc(100vh-72px)]">
        <Card className="flex flex-1 flex-col overflow-hidden rounded-b-none p-0">
          <div
            ...
            style={{
              backgroundColor:
                categoryColorMap[application.category] ?? '#E9E9E9',
            }}
          >
            <button
              type="button"
          ...
          <div className="px-8 py-7 sm:px-10 sm:py-10">
            <div className="flex-1 items-center">
              <span
                className={`rounded-full px-3 py-1 text-[13px] font-medium sm:text-[15px] ${
                  statusColorMap[application.applicationStatus]
                }`}
              >
            ...
            <div className="mt-7 grid grid-cols-[72px_1fr] items-center gap-y-4 text-[13px] sm:grid-cols-[90px_1fr] sm:gap-y-5 sm:text-[15px]">
              ...
              {application.respondedAt && (
                <>
                  ...
                  <span>{formatDate(application.respondedAt)}</span>
                </>
              )}
            </div>
